...
take_UI1 = PhotoImage(file ='images\\Input_Image.png')
...
bar_plots = PhotoImage(file = 'images\\bar_graph.png')
...
acc=PhotoImage(file='images\\features_accuracy.png')
...
home_R = PhotoImage(file = 'images\\home.png')
...
exit1 = PhotoImage(file = 'images\\Exit_Image.png')
